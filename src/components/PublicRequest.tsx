  ...
  if (ticket) {
    return (
      <main className="maintenance-page">
        <div className="maintenance-mountains" aria-hidden="true">
          <span className="mountain-layer mountain-far"/>
          <span className="mountain-layer mountain-mid"/>
          <span className="mountain-layer mountain-near"/>
        </div>
  ...
  return (
    <main className="maintenance-page">
      ...
      <header className="maintenance-header">
        ...
        <div className="maintenance-secure">
          <ShieldCheck size={14}/>
      ...
      <section className="maintenance-intro">
        <span className="maintenance-eyebrow">NEW MAINTENANCE REQUEST</span>
        <h1>How can we help?</h1>
        <p>
          Tell us what needs attention. We’ll route your request to the right team
      ...
      <form className="maintenance-card" onSubmit={submit}>
        <section className="maintenance-section">
          <div className="maintenance-section-heading">
            ...
            <div>
              ...
              <p>How we can reach you if we need more details.</p>
            </div>
          </div>
        ...
        <section className="maintenance-section">
          <div className="maintenance-section-heading">
            ...
            <div>
              ...
              <p>Tell us what happened and where we should go.</p>
            </div>
          </div>
          ...
          <div className="maintenance-grid two-col">
            ...
            <label>
              Location
              <div className="maintenance-icon-field">
                <MapPin size={15}/>
                <input
                  required
                  value={form.location}
                  onChange={e => set('location',e.target.value)}
                  placeholder="Cedar Lodge · Room 12"
                />
              </div>
            </label>
          </div>
          ...
          <label>
            ...
            <textarea
              ...
              placeholder="What happened? When did it start? Is anyone impacted?"
            />
          </label>
        </section>
        ...
        <section className="maintenance-section maintenance-final-section">
          <div className="maintenance-grid priority-upload-grid">
            <fieldset className="maintenance-priority">
            ...
            <label className="maintenance-upload">
              ...
              <span>
                ...
                <small>Optional · up to 5 images</small>
              </span>
            </label>
          </div>
        </section>
        ...
        <button className="maintenance-submit" disabled={busy}>
          <span>{busy ? 'Submitting…' : 'Submit maintenance request'}</span>
          <ChevronRight size={18}/>
        </button>

        <div className="maintenance-privacy">
          <ShieldCheck size={13}/>
          Your request is securely recorded and visible only to authorized facilities staff.
        </div>
      </form>
    </main>
  );
